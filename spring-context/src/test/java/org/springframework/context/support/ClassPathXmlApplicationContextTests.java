...
public class ClassPathXmlApplicationContextTests {
	...
	@Test
	public void testZpXmlBeanFactory() {
		XmlBeanFactory xmlBeanFactory = new XmlBeanFactory(new ClassPathResource("zp/applicationContext.xml"));
		Student s = (Student) xmlBeanFactory.getBean("student1");
		System.out.println(s.getName());
	}

	@Test
	public void testZpApplicationContext() {
		ApplicationContext context = new ClassPathXmlApplicationContext("zp/applicationContext.xml");
